...
public class FindPivotIndex {
  ...
  public static void main(String[] args) {
    ...
    // You can create an unmodifiable list as follows. In the following example you cannot perform
    // any of the following operations.
    List<Integer> unmodifiableList = List.of(1, 2, 3, 4, 5);
    unmodifiableList.add(6); // Throws unsupported operation exception
    unmodifiableList.remove(2); // Throws unsupported operation exception
    unmodifiableList.set(2, 10);; // Throws unsupported operation exception
